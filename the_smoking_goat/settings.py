"""
Django settings for the_smoking_goat project.
...
ROOT_URLCONF = 'the_smoking_goat.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [TEMPLATES_DIR, os.path.normpath(os.path.join(BASE_DIR, 'templates'))],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'the_smoking_goat.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'thesmokinggoat7@gmail.com'
EMAIL_HOST_PASSWORD = 'mywagwoord'
EMAIL_USE_TLS = True
